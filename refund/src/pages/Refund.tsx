...
const refundSchema = z.object({
  ...
  amount: z.coerce
    ...
    .positive({ message: "Informe um valor que seja válido e superior a 0" }),
});
  ...
  async function onSubmit(e: React.SubmitEvent) {
    ...
    try {
      ...
      await api.post("/refunds", {
        ...data,
        filename: "9489849284952975t4.png",
      });
      ...
      {params.id ? (
        <a
          ...
          className="text-sm text-green-100 font-semibold flex items-center
           justify-center gap-2 my-6 hover:opacity-60 transition ease-linear"
        >
